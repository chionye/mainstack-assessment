    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-0 shadow-none rounded-full"
        ),
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 text-xs rounded-full"
        ),
        ...
        day_today: "bg-[#131316] text-white rounded-full",
        day_outside:
